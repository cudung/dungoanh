                        ...
                        <div class="card-body card-block">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select class="form-control">
                                            @foreach ($data as $k => $v)
                                                <optgroup label="{{$v['d_name']}}">
                                                    @foreach ($v['category'] as $k => $v)
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="Tên sản phẩm" id="email-input" name="name" placeholder="Nhập tên sản phẩm" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <textarea name="desc" id="" cols="30"
                                                  rows="10" placeholder="Mô tả" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="password-input" class=" form-control-label">Thông tin chi tiết</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <textarea name="detail" id="" cols="30"
                                                  rows="10" placeholder="Thông tin chi tiết" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="textarea-input" class=" form-control-label">Số lượng</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input name="qty" id="textarea-input" rows="9" placeholder="Số lượng" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="textarea-input" class=" form-control-label">Giá</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input name="price" id="textarea-input" rows="9" placeholder="Giá" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
