                        ...
                        <div class="header-links">
                            <ul class="list-unstyled list-inline pull-left">
                                ...
                                <li><a href="#" onclick="event.preventDefault();
                                 document.getElementById('logout-form').submit();">Checkout</a></li>
    ...
    <section class="products-list">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="product-col">
                    <div class="image">
                        <img src="images/product-images/18.jpg" alt="product" class="img-responsive" />
                    </div>
                    <div class="caption">
                        <h4><a href="product.html">Simply Organic Seeds</a></h4>
                        <div class="description">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="product-col">
                    <div class="image">
                        <img src="images/product-images/19.jpg" alt="product" class="img-responsive" />
                    </div>
                    <div class="caption">
                        <h4><a href="product.html">Simply Organic Seeds</a></h4>
                        <div class="description">
